                ...
                {balancesLoading || transferInProgress ? (
                    ...
                    <Tabs defaultActiveKey='deposit' className="mb-3">
                        ...
                        <Tab eventKey='deposit' title='Deposit'>
                            ...
                            {/* DEPOSIT TOKEN FORM */}
                            <TransferForm submitHandler={depositTokenHandler} valueHandler={setTokenDepositAmount} tokenType='NKC' transferType='Deposit' />
                        ...
                        <Tab eventKey='withdraw' title='Withdraw'>
                            ...
                            {/* WITHDRAW TOKEN FORM */}
                            <TransferForm submitHandler={withdrawTokenHandler} valueHandler={setTokenWithdrawAmount} tokenType='NKC' transferType='Withdraw' />
